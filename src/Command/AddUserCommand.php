 ...
 *
 * @author Jo Molat <jmolat@outlook.com>
 */
class AddUserCommand extends Command
{
    ...
    {
        if (null !== $input->getArgument('username') && null !== $input->getArgument('password') && null !== $input->getArgument('email') && null !== $input->getArgument('firstname') && null !== $input->getArgument('lastname')) {
            return;
        }

        $this->io->title('Create User Command Interactive Wizard');
        $this->io->text([
    ...
    private function validateUserData($username, $plainPassword, $email, $firstname, $lastname)
    {
...
The <info>%command.name%</info> command creates new users and saves them in the database:
  ...
  <info>php %command.firstname%</info> <comment>username password email</comment>

By default the command creates regular users. To create administrator users,
add the <comment>--admin</comment> option:

  <info>php %command.firstname%</info> username password email <comment>--admin</comment>

If you omit any of the three required arguments, the command will ask you to
provide the missing values:

  # command will ask you for the email
  <info>php %command.firstname%</info> <comment>username password</comment>

  # command will ask you for the email and password
  <info>php %command.firstname%</info> <comment>username</comment>

  # command will ask you for all arguments
  <info>php %command.firstname%</info>
